...
.run(function($ionicPlatform, $ionicPopup, $cordovaSQLite) {
  ...
  $ionicPlatform.ready(function() {
    ...
    $cordovaSQLite.execute(db, 'CREATE TABLE IF NOT EXISTS ingredients (ING_ID INTEGER PRIMARY KEY AUTOINCREMENT,ING_NOM TEXT,ING_PRIX REAL,ING_CATEGORIE TEXT, ING_TIME INTEGER)');
    ...
    sql = 'REPLACE INTO `ingredients` (`ING_ID`, `ING_NOM`, `ING_PRIX`, `ING_CATEGORIE`, `ING_TIME`) VALUES';
    sql += '(1, "Mozzarela", 1.5, "FROMAGE", 45),';
    sql += '(2, "Oignon", 1.1, "AUTRES", 50),';
    sql += '(3, "Tomates fraîches", 1.2, "AUTRES", 55),';
    sql += '(4, "Sauce au poivre", 1.6, "SAUCE", 60),';
    sql += '(5, "Boulettes de bœuf épicé", 2, "VIANDE", 90),';
    sql += '(6, "Champignons", 1.2, "AUTRES", 65),';
    sql += '(7, "Poulet rôti", 2.2, "VIANDE", 95),';
    sql += '(8, "Sauce à la moutarde à l""ancienne", 1.3, "SAUCE", 70),';
    sql += '(9, "Bacon", 1.8, "VIANDE", 100),';
    sql += '(10, "Potatoes", 1.1, "AUTRES", 75),';
    sql += '(11, "Raclette", 1.4, "FROMAGE", 80),';
    sql += '(12, "Lardons fumés", 1.7, "VIANDE", 105),';
    sql += '(13, "Pommes de terre", 1.2, "AUTRES", 75),';
    sql += '(14, "Reblochon", 1.7, "FROMAGE", 70),';
    sql += '(15, "Chèvre", 1.4, "FROMAGE", 65),';
    sql += '(16, "Miel", 1, "SAUCE", 60),';
    sql += '(17, "Poivrons mélangés", 1, "AUTRES", 65),';
    sql += '(18, "Sauce curry", 1.2, "SAUCE", 25),';
    sql += '(19, "Jambon", 1.5, "VIANDE", 110),';
    sql += '(20, "Origan", 1.1, "AUTRES", 15),';
    sql += '(21, "Sauce barbecue", 1.2, "SAUCE", 45),';
    sql += '(22, "MERGUEZ", 2.1, "VIANDE", 115),';
    sql += '(23, "Saucisson pepperoni", 2.4, "VIANDE", 120),';
    sql += '(24, "Emmental", 1.5, "FROMAGE", 60),';
    sql += '(25, "Saumon fumé", 3, "VIANDE", 125),';
    sql += '(26, "Aneth", 0.7, "AUTRES", 35),';
    sql += '(27, "Fourme d""Ambert", 1.4, "FROMAGE", 55),';
    sql += '(28, "Olives noires", 1.7, "AUTRES", 60),';
    sql += '(29, "Ananas", 1.9, "AUTRES", 60)';
    $cordovaSQLite.execute(db, sql);
